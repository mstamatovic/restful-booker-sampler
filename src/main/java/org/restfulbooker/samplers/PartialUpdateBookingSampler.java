...
public class PartialUpdateBookingSampler extends AbstractJavaSamplerClient {
    ...
    public Arguments getDefaultParameters() {
        ...
        args.addArgument("payload", "{ \"firstname\" : \"James\" }");
        return args;
    }
    ...
    public SampleResult runTest(JavaSamplerContext ctx) {
        ...
        String payload = ctx.getParameter("payload");
        ...
        try {
            ...
            conn.setRequestMethod("PATCH"); // ← razlika
